...
<head>
    ...
    <link rel="shortcut icon" href="assets/sassio/img/fv.png" type="image/x-icon">
    <link rel="icon" href="assets/sassio/img/fv.png" type="image/x-icon">
    <link rel="stylesheet" href="assets/sassio/css/bootstrap.min.css">
    <link rel="stylesheet" href="assets/sassio/css/animate.css">
    <link rel="stylesheet" href="assets/sassio/css/newfont.css">
    <link rel="stylesheet" href="assets/sassio/css/owl.carousel.css">
    <link rel="stylesheet" href="assets/sassio/css/fontawesome-all.css">
    <link rel="stylesheet" href="assets/sassio/css/swiper.css">
...
<body class="app-eight-home" data-spy="scroll" data-target=".navigation-eight" data-offset="80">
        ...
        <header id="header-eight" class="main-header-eight">
            <div class="appheader-content">
                <div class="site-logo float-left">
                    <a href="#"><img src="assets/sassio/img/app-landing/logo/logo1.png" alt=""></a>
                </div>
        ...
        <section id="eight-banner" class="eight-banner-section position-relative">
                    ...
                    <div class="col-lg-12">
                        <div class="eight-banner-content">
                            <div class="banner-content-box appeight-headline pera-content">
                                <h1 class="cd-headline clip is-full-width">
                                    ...
                                    <span class="cd-words-wrapper">
                                        <b class="is-visible">Aplikasi Web</b>
                                        <b>Aplikasi Android</b>
                                        <b>Landing Page</b>
                                    </span>
                                </h1>
                                <P>Buat Bisnis Anda Lebih Maju Dan Terlihat Lebih Profesional dengan Website dan Aplikasi Android yang Berkualitas </P>
                            ...
                            <div class="ei-banner-mbl-mockup wow fadeInRight" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <img src="assets/sassio/img/app-landing/mockup/bm1.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="waveWrapper waveAnimation">
                <div class="waveWrapperInner bgTop">
                    <div class="wave waveTop" style="background-image: url('assets/sassio/img/app-landing/shape/b-shapeup.png')"></div>
                </div>
                <div class="waveWrapperInner bgMiddle">
                    <div class="wave waveMiddle" style="background-image: url('assets/sassio/img/app-landing/shape/b-shapemiddle.png')"></div>
                </div>
                <div class="waveWrapperInner bgBottom">
                    <div class="wave waveBottom" style="background-image: url('assets/sassio/img/app-landing/shape/b-shapemiddle.png')"></div>
                </div>
            </div>
        </section>
        ...
        <section id="feature-eight" class="feature-eight-section position-relative">
            <div class="container">
                <div class="eight-section-title appeight-headline pera-content text-center">
                    ...
                    <h2>Website / Aplikasi
                        <span>apa yang anda butuhkan ?</span></h2>
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-lg-3 col-md-6  wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="eight-feature-box text-center position-relative">
                                    ...
                                    <div class="feature-text8 appeight-headline pera-content">
                                        ...
                                        <p>Bangun Citra Merek Anda dengan Landing Page yang Memukau dan merk anda terkenal</p>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 wow fadeFromUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div class="eight-feature-box text-center position-relative">
                                    ...
                                    <div class="feature-text8 appeight-headline pera-content">
                                        <h3>Web Data Proses</h3>
                                        <p>Dengan membuat website pengolahan data, pekerjaan anda akan lebih efektif dan efisien.</p>
                                    </div>
                                    {{-- <div class="ei-feature-more">
                                        <a href="#"><i class="fas fa-plus"></i></a>
                                    </div> --}}
                            ...
                            <div class="col-lg-3 col-md-6 wow fadeFromUp" data-wow-delay="900ms" data-wow-duration="1500ms">
                                <div class="eight-feature-box text-center position-relative">
                                    ...
                                    <div class="feature-text8 appeight-headline pera-content">
                                        <h3>Apilkasi Mobile</h3>
                                        <p>Mempercepat Pertumbuhan Bisnis Anda dengan Aplikasi Android dan IOS yang Efektif. </p>
                                    </div>
                                    {{-- <div class="ei-feature-more">
                                        <a href="#"><i class="fas fa-plus"></i></a>
                                    </div> --}}
                            ...
                            <div class="col-lg-3 col-md-6 wow fadeFromUp" data-wow-delay="1200ms" data-wow-duration="1500ms">
                                <div class="eight-feature-box text-center position-relative">
                                    ...
                                    <div class="feature-text8 appeight-headline pera-content">
                                        ...
                                        <p>Optimalkan Proses Bisnis Anda dengan Aplikasi Inventory yang Terintegrasi, Kontrol Stok Anda </p>
                                    </div>
                                    {{-- <div class="ei-feature-more">
                                        <a href="#"><i class="fas fa-plus"></i></a>
                                    </div> --}}
                ...
                <div class="ei-feature-shape"><img src="assets/sassio/img/app-landing/shape/f-shape1.png" alt=""></div>
            </section>
    ...
    <!-- Start of service  section
        ============================================= -->
        <section id="feature-eight" class="eight-service-section position-relative">
            <div class="container">
                        ...
                        <div class="banner-pager clearfix" id="banner-pager">
                            <a class="pager" data-slide-index="0">
                                <div class="ei-service-icon-text text-right appeight-headline pera-content">
                                    ...
                                    <div class="ei-service-text">
                                        ...
                                        <p>Kami menjamin waktu pengerjaan yang singkat tanpa mengorbankan kualitas</p>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a class="pager" data-slide-index="1">
                                <div class="ei-service-icon-text text-right appeight-headline pera-content">
                                    ...
                                    <div class="ei-service-text">
                                        ...
                                        <p>Kami menggunakan teknologi terkini untuk memastikan website Anda memiliki performa yang baik dan aman</p>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a class="pager" data-slide-index="2">
                                <div class="ei-service-icon-text text-right appeight-headline pera-content">
                                    ...
                                    <div class="ei-service-text">
                                        <h3>Bergaransi</h3>
                                        <p>Kami memberikan garansi untuk website yang kami buat agar Anda merasa lebih tenang dan terjamin. Jika ada kendala kami siap membantu tanpa dipungut biaya.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
            ...
            <div class="s-shape-bg1" data-parallax='{"x" : -70}'><img src="assets/sassio/img/app-landing/shape/s-shape3.png" alt=""></div>
            <div class="s-shape-bg2 text-center"><img src="assets/sassio/img/app-landing/shape/s-shape4.png" alt=""></div>
        </section>
        ...
        <section id="fun-fact" class="eg-fun-fact-section position-relative">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="eg-funfact-content clearfix position-relative">
                            <div class="eg-fun-fact-mockup wow fadeFromLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                                ...
                                <div class="fn-shape fn-shape-item1" data-parallax='{"y" : 50}'><img src="assets/sassio/img/app-landing/mockup/fmu2.png" alt=""></div>
                                <div class="fn-shape fn-shape-item2" data-parallax='{"y" : 60}'><img src="assets/sassio/img/app-landing/mockup/fmu3.png" alt=""></div>
                                <div class="fn-shape fn-shape-item3" data-parallax='{"x" : -50}'><img src="assets/sassio/img/app-landing/shape/fc1.png" alt=""></div>
                                <div class="fn-shape fn-shape-item4" data-parallax='{"x" : -40}'><img src="assets/sassio/img/app-landing/shape/fc2.png" alt=""></div>
                            </div>
                    ...
                    <div class="fn-bg-shape position-absolute"><img src="assets/sassio/img/app-landing/shape/fns1.png" alt=""></div>
                </section>
    ...
    <!-- Start of How work  section
        ...
        {{-- <section id="eg-how-work" class="eg-how-work-section position-relative">
            <div class="how-work-bg-shape position-absolute"><img src="assets/sassio/img/app-landing/shape/hws.png" alt=""></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                    ...
                    <div class="col-lg-5">
                        <div class="how-work-mockup position-relative wow fadeFromUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                            ...
                            <div class="hw-shape1 position-absolute" data-parallax='{"x" : 40}'><img src="assets/sassio/img/app-landing/shape/fc1.png" alt=""></div>
                            <div class="hw-shape2 position-absolute" data-parallax='{"x" : -30}'><img src="assets/sassio/img/app-landing/shape/fc2.png" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Start of App Download  section
        ...
        <section id="ei-appdownload" class="ei-appdownload-section position-relative" data-background="assets/sassio/img/app-landing/background/appbg1.png">
            ...
            <div class="ei-appdownloaad-shape app-shape3" data-parallax='{"y" : -100}'><img src="assets/sassio/img/app-landing/background/apps3.png" alt=""></div>
        </section>
                    ...
                    <div class="ei-team-pic-text wow fadeFromLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="ei-team-img position-relative">
                            <div class="team-mem-img-ei text-center position-relative">
                                ...
                                <span class="mshape-bg shape-bg1"><img src="assets/sassio/img/app-landing/team/msbg1.png" alt=""></span>
                                <span class="mshape-bg shape-bg2"><img src="assets/sassio/img/app-landing/team/msbg2.png" alt=""></span>
                            </div>
    ...
    <!-- Start of screen-shoot section
        ...
        {{-- <section id="ei-screenshots" class="ei-screenshots-section position-relative">
            <div class="container">
                <div class="eight-section-title appeight-headline pera-content text-center">
                    ...
                    <div class="row ei-appScreenshotCarousel-container swiper-container">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" style="background-image:url(assets/sassio/img/app-landing/screenshoot/screenshot01.png)"></div>
                            <div class="swiper-slide" style="background-image:url(assets/sassio/img/app-landing/screenshoot/screenshot02.png)"></div>
                            <div class="swiper-slide" style="background-image:url(assets/sassio/img/app-landing/screenshoot/screenshot03.png)"></div>
                            <div class="swiper-slide" style="background-image:url(assets/sassio/img/app-landing/screenshoot/screenshot04.png)"></div>
                            <div class="swiper-slide" style="background-image:url(assets/sassio/img/app-landing/screenshoot/search.png)"></div>
                            <div class="swiper-slide" style="background-image:url(assets/sassio/img/app-landing/screenshoot/screenshot01.png)"></div>
                            <div class="swiper-slide" style="background-image:url(assets/sassio/img/app-landing/screenshoot/screenshot02.png)"></div>
                            <div class="swiper-slide" style="background-image:url(assets/sassio/img/app-landing/screenshoot/screenshot03.png)"></div>
                            <div class="swiper-slide" style="background-image:url(assets/sassio/img/app-landing/screenshoot/screenshot04.png)"></div>
                ...
                <div class="screenshoot-vector screenshoot-shape1 position-absolute"> <img src="assets/sassio/img/app-landing/shape/ss-shape1.png" alt=""></div>
                <div class="screenshoot-vector screenshoot-shape2 position-absolute"> <img src="assets/sassio/img/app-landing/shape/ss-shape2.png" alt=""></div>
            </section> --}}
   ...
   <!-- Start of Testimonial section
    ============================================= -->
    <section id="ei-testimonial" class="ei-testimonial-section position-relative" data-background="assets/sassio/img/app-landing/background/tbg.jpg">
        <div class="container">
            <div class="eight-section-title appeight-headline pera-content text-center">
                <span class="eg-title-tag">
                ...
                <div id="testimonial-scroller" class="testimonial-scroller-area owl-carousel">
                    <div class="ei-testimonial-img-text position-relative">
                        ...
                        <div class="ei-testimonial-img float-left text-center">
                            <img src="assets/sassio/img/app-landing/testimonial/tst1.jpg" alt="">
                        </div>
                    ...
                    <div class="ei-testimonial-img-text position-relative">
                        ...
                        <div class="ei-testimonial-img float-left text-center">
                            <img src="assets/sassio/img/app-landing/testimonial/tst2.jpg" alt="">
                        </div>
                        <div class="ei-testimonial-text">
                            <div class="ei-testimonial-name appeight-headline pera-content">
                                <h3>Liana Zhu</h3>
        ...
        <div class="testimonial-floatingimg testimonial-float-img1 ul-li-block">
            <ul>
                <li><img src="assets/sassio/sassio/img/app-landing/testimonial/tf1.jpg" alt=""></li>
                <li><img src="assets/sassio/img/app-landing/testimonial/tf3.jpg" alt=""></li>
                <li><img src="assets/sassio/img/app-landing/testimonial/tst1.jpg" alt=""></li>
        ...
        <div class="testimonial-floatingimg testimonial-float-img2 ul-li-block">
            <ul>
                <li><img src="assets/sassio/img/app-landing/testimonial/tf1.jpg" alt=""></li>
                <li><img src="assets/sassio/img/app-landing/testimonial/tf3.jpg" alt=""></li>
                <li><img src="assets/sassio/img/app-landing/testimonial/tst1.jpg" alt=""></li>
                <li><img src="assets/sassio/img/app-landing/testimonial/tst2.jpg" alt=""></li>
            </ul>
    ...
    <!-- Start of Faq section
        ...
        {{-- <section id="ei-faq" class="ei-faq-section position-relative">
            <div class="container">
                ...
                <span class="ei-faq-shape fq-shape-style1" data-parallax='{"x" : 50}'><img src="assets/sassio/img/app-landing/shape/fq-shape1.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style2"><img src="assets/sassio/img/app-landing/shape/fq-shape2.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style3"><img src="assets/sassio/img/app-landing/shape/fq-shape3.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style4" data-parallax='{"y" : 60}'><img src="assets/sassio/img/app-landing/shape/fq-shape4.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style5"><img src="assets/sassio/img/app-landing/shape/fq-shape5.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style6"><img src="assets/sassio/img/app-landing/shape/fq-shape6.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style8"><img src="assets/sassio/img/app-landing/shape/fq-shape8.png" alt=""></span>
                <span class="ei-faq-shape fq-shape-style7"><img src="assets/sassio/img/app-landing/shape/fq-shape7.png" alt=""><img src="assets/sassio/img/app-landing/shape/fq-shape7.png" alt="">
                    <img src="assets/sassio/img/app-landing/shape/fq-shape7.png" alt=""></span>
        </section> --}}
    <!-- End of Faq section
        ============================================= --> 
                ...
                <div class="ei-partner-content">
                    <div id="ei-partner-slide" class="partner-slide-area owl-carousel">
                        <div class="partner-img">
                            <img src="assets/sassio/img/app-landing/partner/p1.png" alt="">
                        </div>
                        <div class="partner-img">
                            <img src="assets/sassio/img/app-landing/partner/p2.png" alt="">
                        </div>
                        <div class="partner-img">
                            <img src="assets/sassio/img/app-landing/partner/p3.png" alt="">
                        </div>
                        <div class="partner-img">
                            <img src="assets/sassio/img/app-landing/partner/p4.png" alt="">
                        </div>
     ...
     <!-- Start of Newslatter  section
        ...
        <section id="ei-newslatter" class="ei-newslatter-section position-relative">
            <div class="ei-newslatter-box position-relative">
                ...
                <div class="ei-news-vector1 position-absolute"><img src="assets/sassio/img/app-landing/shape/n-shape1.png" alt=""></div>
                <div class="ei-news-vector2 position-absolute"><img src="assets/sassio/img/app-landing/shape/n-shape2.png" alt=""></div>
                <div class="ei-news-vector3 position-absolute" data-parallax='{"x" : 50}'><img src="assets/sassio/img/app-landing/shape/n-shape3.png" alt=""></div>
            </div>
     ...
     <!-- End of Newslatter  section
      ...
      <!-- Start of Footer  section
        ...
        <section id="ei-footer" class="ei-footer-section position-relative">
                    ...
                    <div class="col-lg-4">
                        <div class="ei-footer-widget pera-content appeight-headline">
                            ...
                            <div class="ei-payment-mathod">
                                <img src="assets/sassio/img/app-landing/logo/paypal.png" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <div class="ei-footer-widget appeight-headline  ul-li-block">
                            ...
                            <div class="download-btn">
                                <a href="#"><img src="assets/sassio/img/app-landing/logo/app1.png" alt=""></a>
                                <a href="#"><img src="assets/sassio/img/app-landing/logo/gp1.png" alt=""></a>
                            </div>
            ...
            <div class="ei-footer-shape1 position-absolute" data-parallax='{"x" : 60}'><img src="assets/sassio/img/app-landing/shape/fo-shape1.png" alt=""></div>
            <div class="ei-footer-shape2 position-absolute" data-parallax='{"y" : 60}'><img src="assets/sassio/img/app-landing/shape/fo-shape2.png" alt=""></div>
            <div class="ei-footer-shape3 position-absolute"><img src="assets/sassio/img/app-landing/shape/eimap.png" alt=""></div>
        </section>
      <!-- End of Footer  section
        ============================================= -->            

        <!-- JS library -->
        <script src="assets/sassio/js/jquery.js"></script>
        <script src="assets/sassio/js/popper.min.js"></script>
        <script src="assets/sassio/js/bootstrap.min.js"></script>
        <script src="assets/sassio/js/appear.js"></script>
        <script src="assets/sassio/js/owl.js"></script>
        <script src="assets/sassio/js/wow.min.js"></script>
        <script src="assets/sassio/js/aos.js"></script>
        <script src="assets/sassio/js/slick.js"></script>
        <script src="assets/sassio/js/pagenav.js"></script>
        <script src="assets/sassio/js/odometer.js"></script>
        <script src="assets/sassio/js/bxslider.js"></script>
        <script src="assets/sassio/js/jquery.barfiller.js"></script>
        <script src="assets/sassio/js/jquery.mCustomScrollbar.concat.min.js"></script>
        <script src="assets/sassio/js/parallax-scroll.js"></script>
