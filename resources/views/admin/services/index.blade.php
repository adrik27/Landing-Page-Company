                ...
                <div class="card" id="orderList">
                    <div class="card-header mb-2  border-0">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title mb-0 flex-grow-1">Service Table</h5>
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            ...
                                            <td class="customer_name">
                                                <img src="{{ asset('storage/'). '/' . $serv->image }}" height="45"
                                                    alt="">
                                            </td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/services" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                <label for="customername-field" class="form-label">Tittle</label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea type="text" name="deskripsi" id="customername-field"
                                                    class="form-control @error('deskripsi')is-invalid @enderror"
                                                    placeholder="Enter Deskripsi" value="{{ old('deskripsi') }}"
